        ...
        steps: [
          {
            ...
            items: [
              ...
              "从产品定义阶段同步考虑PCBA加工、SMT贴片加工及测试验证需求",
              "输出系统架构方案、项目立项建议及整体研发周期计划"
            ],
          },
          {
            icon: Cpu,
        ...
        models: [
          {
            ...
            description:
            ["百千成电子为客户提供覆盖产品定义、研发设计、认证导入、量产制造及售后支持的ODM一站式服务。\n",
"户可专注于市场销售与行业应用，我们则围绕产品功能、核心元器件选型、硬件软件开发、DFM评估及测试方案规划提供研发支持。依托自有SMT贴片厂的制造体系，以及SMT贴片加工、PCBA加工、功能测试和整机组装经验，帮助客户缩短开发周期，降低试错成本，实现产品从方案设计到稳定量产的高效落地。"]
        ...
        summary:
          "百千成电子通过 ODM + JDSM 灵活合作模式，为客户提供研发协同、工程验证、量产导入及供应链支持。客户既可选择完整ODM托付，也可按需开展JDSM模块化合作。依托自有SMT贴片厂的制造体系，以及SMT贴片加工、PCBA加工和测试验证经验，我们可在设计阶段同步考虑可制造性、成本控制与量产稳定性，帮助客户以更低风险、更高效率将产品推向市场。"
      },
      ipPolicy: {
        title: "知识产权开放政策",
        description:
          "百千成电子作为专业的PCBA贴片加工厂，在ODM及JDSM合作中，百千成电子坚持开放透明的项目管理和资料交付机制。在项目完成后，可根据双方约定，向客户交付项目相关的设计资料、工程文件，包括但不限于：",
