...
export default function DevelopmentHistoryPage({ params }: { params: { locale: string } }) {
  ...
  const content = {
    ...
    en: {
      ...
      milestones: [
        { year: "2004.01", title: "BQC was established in Bantian, Longgang District, Shenzhen; Designed and manufactured solar photovoltaic inverters for German clients" },
        ...
        { year: "2009", title: "Successfully introduced VOIP telephone product project" },   
