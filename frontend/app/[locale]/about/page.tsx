...
export default function AboutPage({ params }: { params: { locale: string } }) {
  ...
  const content = {
    zh: {
      ...
      companyName: "百千成电子",
      intro1: "深圳市百千成电子有限公司成立于2003年，是专业从事储能锂电池BMS设计制造，PCS/逆变器、智能机器人电路板PCBA设计制造企业。",
      intro2: "公司已通过ISO9001、ISO14001、ISO13485、IATF16949、管理体系认证，拥有完整的数字化管理平台，确保每片PCBA板高品质交付。",
      learnMore: "了解更多详情",
      videoUnsupported: "您的浏览器不支持视频播放。",
      statsTitle: "数据统计",
      stats: [
        { number: "22+", label: "年行业经验", description: "深耕储能BMS领域" },
        { number: "50GWh+", label: "累计装机量", description: "储能BMS产品装机容量" },
    ...
    en: {
      ...
      intro2: "The company has passed ISO9001, ISO14001, ISO13485 and IATF16949 management system certifications, and has a complete digital management platform to ensure high-quality delivery of each PCBA board.",
      ...
      stats: [
        ...
        { number: "50GWh+", label: "Installed Capacity", description: "Energy storage BMS product installations" },
