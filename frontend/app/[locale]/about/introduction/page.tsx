    ...
    zh: {
      ...
      overview: {
        ...
        paragraphs: [
          ...
          // ====== 你新增的中文内容 ======
          "◆ 百千成（BQC）：自2003年起，值得信赖的电子制造合作伙伴。作为领先的电子制造服务（EMS）供应商，深圳市百千成电子有限公司（BQC Electronics）提供全方位的印刷电路板组装（PCBA）、机械设计与组装、整机组装及测试服务。业务广泛涵盖储能（BMS）、工业控制器、消费电子、通信电子、医疗设备及定制化电子等多个行业。",
          ...
          <ul key="zh-ms-lines" className="list-disc pl-6 space-y-1 font-medium text-xl">
            <li>4条全自动SMT生产线</li>
            <li>2条自动THT生产线</li>
            <li>日产能达864万贴片点</li>
          </ul>,
          ...
          <p key="zh-core-title" className="font-semibold text-xl mt-6">BQC Tech 核心优势</p>,
          ...
          <p key="zh-core-2" className="font-semibold text-xl">2. 深厚的技术与工程资源</p>,
          ...
          "深圳工厂年产能达35GWh+，拥有22条SMT产线和完善的检测体系；马来西亚工厂辐射欧美市场，均通过ISO9001/14001、IATF16949、ISO13485等认证。",
      ...
      overview: {
        ...
        paragraphs: [
          ...
          <ul key="en-strategy" className="list-disc pl-6 space-y-1 font-medium text-xl">
            ...
            <li>European/American markets responsiveness</li>
          </ul>,
          ...
          "Our Shenzhen facility boasts an annual capacity of 35GWh+, with 22 SMT lines and a comprehensive quality inspection system. Our Malaysia plant serves European/American markets, with certifications including ISO9001/14001, IATF16949, and ISO13485.",
