...
async function fetchIndustrialControlBoardsData(locale: string) {
  const categoryQuery = `
...
export default async function IndustrialControlBoardsPage({
  ...
  return (
    <PageLayout
      title={
        categoryInfo?.title ||
        (locale === "en" ? "Industrial Control Boards" : "工业控制板")
      }
      subtitle={
        categoryInfo?.description ||
        (locale === "en"
          ? "Reliable and Stable Industrial Control Boards"
          : "可靠稳定的工业控制板卡")
      }
      breadcrumbs={[
        {
          label: locale === "en" ? "Products Center" : "产品中心",
