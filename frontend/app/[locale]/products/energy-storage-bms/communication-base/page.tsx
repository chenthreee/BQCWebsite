...
async function fetchCommunicationBaseData(locale: string) {
  const productsQuery = `
...
export default async function CommunicationBaseBmsPage({
  ...
  return (
    <PageLayout
      title={
        categoryInfo?.title ||
        (locale === "en" ? "Communication Base Station BMS" : "通信基站BMS")
      }
      subtitle={
        categoryInfo?.description ||
        (locale === "en"
          ? "High-reliability Communication Base Station Battery Management System"
          : "高可靠性通信基站电池管理系统")
      }
      breadcrumbs={[
