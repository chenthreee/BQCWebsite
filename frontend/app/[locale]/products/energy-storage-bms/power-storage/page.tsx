  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[
        ...
        { label: t("breadcrumb_power"), href: `/${locale}/products/energy-storage-bms/power-storage.html` },
      ]}
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {localizedProducts.map((product) => (
            <Link
              key={product.id}
              href={`/${locale}/products/energy-storage-bms/power-storage/${product.id}.html`}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <Link
              href={`/${locale}/products/energy-storage-bms/power-storage/case-grid.html`}
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <Link
              href={`/${locale}/products/energy-storage-bms/power-storage/case-renewable.html`}
              className="text-blue-600 hover:text-blue-800 flex items-center text-sm font-medium"
            >
              {t("details")}
              <ArrowRight className="ml-1 h-4 w-4" />
