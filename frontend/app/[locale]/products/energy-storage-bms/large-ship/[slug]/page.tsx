  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[
        ...
        { label: product.sub_category?.title || (locale === "en" ? "Large Ship BMS" : "大型船舶BMS"), href: `/${locale}/products/energy-storage-bms/large-ship.html` },
        { label: product.title, href: `/${locale}/products/energy-storage-bms/large-ship/${params.slug}.html` },
      ]}
      backgroundImage="/images/products/largeShipBreadcrumb.png"
    >
            ...
            {relatedProducts.map((item: any) => (
              <div key={item.documentId} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-4">
                  ...
                  <Link
                    href={`/${locale}/products/energy-storage-bms/large-ship/${item.slug}.html`}
