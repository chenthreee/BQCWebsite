  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[
        ...
        { label: product.sub_category?.title || (locale === "en" ? "Small Ship BMS" : "小型船舶BMS"), href: `/${locale}/products/energy-storage-bms/small-ship.html` },
        { label: product.title, href: `/${locale}/products/energy-storage-bms/small-ship/${params.slug}.html` },
      ]}
            ...
            {relatedProducts.map((item: any) => (
              <div key={item.documentId} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-4">
                  ...
                  <Link
                    href={`/${locale}/products/energy-storage-bms/small-ship/${item.slug}.html`}
